    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Com qual combustível você quer abastecer seu veículo? a(álcool)  g(gasolina)");
                string comb = Console.ReadLine().ToLower();
                if (comb == "g")
                {
                    Console.WriteLine("Quantos litros de gasolina você pretende colocar no seu carro? O preço da gasolina está R$5,30.");
                ...
                {
                    Console.WriteLine("Quantos litros de ácool você pretende colocar no seu carro? O preço do álcool está R$4,90.");
